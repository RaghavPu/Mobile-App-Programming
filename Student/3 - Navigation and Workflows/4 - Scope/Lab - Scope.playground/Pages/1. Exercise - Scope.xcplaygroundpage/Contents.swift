...
// Foo is not defined outside the for loop
...
// there is an x in the global scope, so it can be accessed in both locations
...
greeting(greeting: "Hi there", name: "Raghav")
greeting(greeting: nil, name: "Raghav")
...
var car = Car(make: "Honda", model: "CRV", year: 2017)
print(car.model)
/*:
