...
// the division value is more accurate and is precise, rather than being truncated to an integer value in integer division
/*:
...
print("Even: \(even % 2)")
print("Odd: \(odd % 2)")
// a remainder of 1 indicates an odd number, while a remainder of 0 indicates an even number
/*:
