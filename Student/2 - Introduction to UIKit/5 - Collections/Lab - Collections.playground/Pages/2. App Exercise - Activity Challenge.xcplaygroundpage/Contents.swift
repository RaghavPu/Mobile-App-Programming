 ...
 */
var runningChallenges = ["Walk 3 miles a day", "Walk 10 miles a day"]
var walkingChallengs = ["Run 5 times a week", "Run a mile in under a minute"]
...
var challenges = [runningChallenges, walkingChallengs]
...
if committedChallenges.isEmpty {
   print("Commit to a challenge! Come on!!")
} else if committedChallenges.count == 1 {
    print("The challenege you have chosen is \(committedChallenges[0])")
} else {
